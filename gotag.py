from gotaglio.tools.constants import log_folder, model_config_file
from gotaglio.tools.models import register_models
from gotaglio.tools.pipelines import register_pipelines
from gotaglio.tools.run import Runner
...
def main():
    ...
    # run_parser.add_argument('template', type=str, help='The name of the pipeline to run')
...
def run_pipeline(cases_file, pipeline, config):
    runner = Runner()
    register_models(runner)
    register_pipelines(runner)
